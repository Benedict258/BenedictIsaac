...
const Testimonials = () => {
  const testimonials = [
    {
      id: 1,
      name: 'Pathway Quest Scholars',
      role: 'Educational Platform',
      company: 'Pathway Quest Scholars',
      content: 'Benedict went above and beyond to bring our vision to life. The system is fast, stable, and beautifully designed.',
      rating: 5,
      avatar: 'https://images.unsplash.com/photo-1494790108755-2616b612b789?w=150&h=150&fit=crop&crop=face',
    },
    {
      id: 2,
      name: 'TendX Smart Attendance',
      role: 'Attendance Management System',
      company: 'TendX',
      content: 'His responsiveness and ability to simplify complex ideas made the entire process seamless. Highly recommended.',
      rating: 5,
      avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&h=150&fit=crop&crop=face',
    },
    {
      id: 3,
      name: 'Creative Preview Website',
      role: 'Portfolio Showcase',
      company: 'Creative Preview',
      content: 'An amazing collaboration! The design and speed of delivery exceeded expectations.',
      rating: 5,
